import {
  ...
  export const ProdutosSemTroca = () => {
    ...
    const [descricaoProduto, setDescricaoProduto] = useState(null);
    const [codigoProduto, setCodigoProduto] = useState(null);
    const [validadeProduto, setValidadeProduto] = useState(null);
    ...
    const dataParaRecolhimento = async (dataAtual) => {
      ...
      const produtoSemTroca = configuracoes.avisoProdutosSemTroca || [];
  
      const milissegundosEmUmDia = 24 * 60 * 60 * 1000;
      const milissegundosParaAdicionar =
      produtoSemTroca * milissegundosEmUmDia;
    ...
    const buscarProduto = async () => {
      try {
        ...
        const produtosRecolhimento = produtos.filter((produto) => {
          ...
          return (validadeProduto.getTime() === dataParaRecolher.getTime() && produto.semTroca === true);
        });
  
        setListaProdutosSemTroca(produtosRecolhimento);
      } catch (error) {
    ...
    return (
      <Container>
        ...
        {inputVisible ? (
          ...
          <>
            <TitleProduto>Produtos sem troca</TitleProduto>
            <ContainerProdutos>
              <ProdutosLista>
                {listaProdutosSemTroca.map((produto) => (
  ...
  export default ProdutosSemTroca;